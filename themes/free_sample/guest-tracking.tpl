	...
	{else}
		<form method="POST" action="{$action|escape:'htmlall':'UTF-8'}#guestToCustomer" class="std guest">
			<fieldset>
				...
				<p class="submit"><input type="submit" class="exclusive_large" name="submitTransformGuestToCustomer" value="{l s='Submit'}" /></p>
			</fieldset>
		</form>
	{/if}
{else}
	...
	<form method="POST" action="{$action|escape:'htmlall':'UTF-8'}" class="std guest">
		<fieldset>
			...
			<p class="submit"><input type="submit" class="exclusive_large" name="submitGuestTracking" value="{l s='View my order'}" /></p>
		</fieldset>
	</form>
{/if}