...
<ul id="footer_links">
	...
	{foreach from=$cmslinks item=cmslink}
		...
		{/if}
	{/foreach}
	{if $display_poweredby}<li class="last_item">&copy; 2012 {l s='Powered by' mod='blockcms'} <a href="http://www.prestashop.com">PrestaShop</a>&trade;. All rights reserved</li>{/if}
</ul>
<!-- /MODULE Block footer -->