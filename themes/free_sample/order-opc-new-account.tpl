		...
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<p class="text">
					...
					<input class="text" type="text" id="login_email" name="email" />
				</p>
				<p class="text">
					<label for="passwd">{l s='Password'}</label>
					<input class="text" type="password" id="passwd" name="passwd" />
{*					<input class="text" type="password" id="login_passwd" name="passwd" />*}
				</p>
				<p class="submit">
		...
		<fieldset>
			...
			<div id="opc_account_form">
				...
				<p class="required text">
					...
					<input class="text" type="text" class="text" id="email" name="email" value="{if isset($guestInformations) && $guestInformations.email}{$guestInformations.email}{/if}" />
					<sup>*</sup>
				</p>
				<p class="required password is_customer_param">
					<label for="passwd">{l s='Password'}</label>
					<input class="text" type="password" class="text" name="passwd" id="passwd" />
					<sup>*</sup>
			...
			{$stateExist = true}
				...
				<p class="submit" id="opc_account_saved">
