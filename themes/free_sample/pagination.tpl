...
{assign var='nArray' value=array((int)(Configuration::get('PS_PRODUCTS_PER_PAGE')), 12, 15, 30)}
{else}
...
{if $start!=$stop}
	...
	{if $nb_products > $products_per_page}
		<form id="pagination_form" action="{if !is_array($requestNb)}{$requestNb}{else}{$requestNb.requestUrl}{/if}" method="get">
